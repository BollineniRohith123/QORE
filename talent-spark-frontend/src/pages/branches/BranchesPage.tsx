...
const BranchesPage = () => {
  ...
  const [branchToDelete, setBranchToDelete] = useState<{ id: number; name: string; isDefault: boolean } | null>(null);
  ...
  const handleDeleteBranch = async (branchId: number, isDefault: boolean) => {
    ...
    // Set the branch to delete and show confirmation dialog
    setBranchToDelete({
      id: branchId,
      name: branch.name,
      isDefault: isDefault
  ...
  const confirmDeleteBranch = async () => {
    ...
    const { id: branchId, name: branchName } = branchToDelete;
