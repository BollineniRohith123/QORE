...
const BranchDetailsPage = () => {
  ...
  const { toast } = useToast();  const [branch, setBranch] = useState<Branch | null>(null);
  ...
  const confirmDeleteBranch = async () => {
    ...
    toast({
      ...
      description: `Please wait while "${branch.name}" is being deleted...`,
    });
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      ...
      <ConfirmationDialog
        ...
        description={
          branch
            ? `Are you sure you want to delete "${branch.name}"? This action cannot be undone and will permanently remove all branch data.`
