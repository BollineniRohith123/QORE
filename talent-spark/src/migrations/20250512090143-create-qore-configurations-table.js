...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.createTable('qore_configurations', {
      id: {
    ...
    await queryInterface.addConstraint('qore_configurations', {
    ...
    // Add indexes
    await queryInterface.addIndex('qore_configurations', ['branch_id'], { name: 'branch_id_idx' });
    await queryInterface.addIndex('qore_configurations', ['is_active'], { name: 'is_active_idx' });
    await queryInterface.addIndex('qore_configurations', ['is_default'], { name: 'is_default_idx' });
    await queryInterface.addIndex('qore_configurations', ['status'], { name: 'status_idx' });
  },

  async down (queryInterface, Sequelize) {
    await queryInterface.dropTable('qore_configurations');
  }
};
